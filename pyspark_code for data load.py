...
# Read the raw data from your Glue Data Catalog
# --- START OF CHANGE ---
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "rj-de-youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0")
# --- END OF CHANGE ---
...
# Write the cleaned data to your specified S3 bucket
# --- START OF CHANGE ---
datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://rj-de-on-youtube-cleaned-useast1-dev/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
# --- END OF CHANGE ---
